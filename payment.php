...
<html lang="en">
    ...
    .custom-header {
        background-color: #FDE49E; /* Custom header background color */
        padding: 15px; /* Add padding to the header */
    }

    .custom-btn {
        background-color: #DD761C; /* Custom button background color */
    ...
    .custom-btn:hover {
        background-color: #c86c1e; /* Darker shade on hover */
    }
</style>
    ...
    <div class="box">
        <div class="card">
            ...
            <div class="card-body mb-3 ">
                ...
                <a href="https://wa.me/6281217332804?text=Hallo,%20saya%20Pelanggan%20dengan%20nama...%0A%0AKonfirmasi%20Pemesanan%20Villa%20di%20Filya%20Suite:%0A%0ANama%3A%0AEmail%3A%0AVilla%3A%0AJumlah%20orang%3A%0ATanggal%3A%0A%0APembayaran%20offline" class="btn custom-btn mb-4 mt-3 w-100" target="_blank">Klik di sini untuk Pembayaran Offline</a>
            </div>
        </div>
    </div>
            ...
            <div class="card-body mb-2">
                <form id="paymentForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="asalbank" class="form-control" placeholder="Masukkan asal pembayaran" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <!-- </div>
                    <button type="button" id="payButton" class="btn custom-btn ">Bayar</button> -->
                    <div class="mb-3">

<div class="text-center mt-3">
    <button type="button" id="payButton" class="btn custom-btn mb-3 mt-4 w-100">Bayar</button>
</div>
        ...
        document.getElementById('payButton').addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Jika ya, lanjutkan dengan logika pembayaran
