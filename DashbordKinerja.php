...
<body>
    ...
    <div class="sidebar">
        ...
        <n class="sidebar-menu">
            ...
            <a href="DashbordKinerja.php" class="menu-item active">
                    ...
                    <?php if (isset($result) && $result->num_rows > 0): ?>
                        <?php while ($laporan = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><?php echo $laporan['tanggal_melapor']; ?></td>
                                ...
                                <td class="text-center">
                                    <a href="proses_kinerja/edit.php?id=<?php echo $laporan['id_pengaduan']; ?>"
                                        class="btn btn-warning btn-sm d-inline-flex align-items-center me-1">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    <a href="proses_kinerja/delete.php?id=<?php echo $laporan['id_pengaduan']; ?>"
